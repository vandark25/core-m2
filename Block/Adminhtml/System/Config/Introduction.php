...
class Introduction extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        <style>
        #metagento_notification_metagento_introduction{display: block !important;background: #f8f8f8;padding: 15px;}
        #metagento_notification_metagento_introduction-head::before{content:"";}
        </style>
        ');
